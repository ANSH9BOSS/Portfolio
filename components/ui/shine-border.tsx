...
interface ShineBorderProps {
  ...
  color?: TColorProp
  className?: string
  // Fix: Made children optional to prevent TypeScript errors in consumers that pass children as nested JSX elements. 
  // This resolves the error where TS fails to correctly infer nested JSX as the 'children' prop in some environments.
